#!/usr/bin/env python3
"""fleet/fleet.py (ground-station) — the VUCM fleet-OTA spine (Mender Management API client).
...
onto: it shells out to mender/artifact/build-artifact.sh, uploads, and deploys.
"""
import argparse
import json
import os
...
BUILD_ARTIFACT = HERE.parent / "mender" / "artifact" / "build-artifact.sh"
